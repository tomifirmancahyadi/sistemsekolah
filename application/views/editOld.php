                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nidn" placeholder="NIDN" name="nidn" value="<?php echo $nidn; ?>" maxlength="128">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="fungsional" class="form-control" id="fungsional" placeholder="Fungsional" name="fungsional" value="<?php echo $fungsional; ?>" maxlength="128">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
